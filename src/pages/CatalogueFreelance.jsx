                                       ...
                                       <div className="contact_blog">
                                          <div className="contact_inner">
                                             <div className="left">
                                                ...
                                                <br/>
                                                <br/>
                                                <p><strong>Domain: </strong>Frontend Developer</p>
                                                <p><strong>Skills: </strong>Frontend Developer</p>
                                                <p><strong>cover letter: </strong>Frontend Developer Frontend Developer Frontend Developer Frontend Developer</p>
                                             </div>
                                             <div className="right">
                                             ...
                                             <div className="bottom_list">
                                                <div className="right_button">
                                                   ...
                                                   <i className="fa fa-user"> </i> View CV
                                                   </button>
                                                </div>
                                             </div>
                                          </div>
